...
{
	assert.throws(function(assert) {var m=new money(5,"EURS");}, DeviseCaracSupException, "Devise supérieure à 3 caractères");
	assert.throws(function(assert) {var m=new money(50.5,"TRUCMUCHE");}, DeviseCaracSupException, "Devise supérieure à 3 caractères");
}
);

QUnit.test("test valeur inférieure à 0", function(assert)
{
	assert.throws(function(assert) {var m=new money(-5,"EUR");}, ValueNegativeException, "Valeur inférieure à 0");
	assert.throws(function(assert) {var m=new money(-12.5,"EUR");}, ValueNegativeException, "Valeur inférieure à 0");
}
);
